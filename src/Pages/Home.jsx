...
const WORDS = ["Hi, I'm Uttam","Computer Science Student", "Tech Enthusiast","Crafting Code"];
const TECH_STACK = ["React", "Javascript", "Node.js", "HTML","CSS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Uttam53" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/uttam-sahu-31v/" },
  { icon: Instagram, link: "https://www.instagram.com/utt_am3.33/?hl=en" }
];
